...
mydat.x1<- read_xlsx("Cleveland Bay timeseries.xlsx", sheet=1)
mydat.x2<- read_xlsx("Cleveland Bay timeseries.xlsx", sheet=2)
mydat.x3<- read_xlsx("Cleveland Bay timeseries.xlsx", sheet=3)
mydat.x4<- read_xlsx("Cleveland Bay timeseries.xlsx", sheet=4)
mydat.x5<- read_xlsx("Cleveland Bay timeseries.xlsx", sheet=5)
