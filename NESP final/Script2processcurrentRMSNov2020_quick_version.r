...
mydat3$currRMS10D90=as.numeric(mydat3$currRMS10D90)
...
mydat3$currRMS3HrD90=as.numeric(mydat3$currRMS3HrD90)
...
mydat3[i,c("currRMS3HrD90")]<-rmsCurr3hrD90
mydat3[i,c("currRMS3HrD95")]<-rmsCurr3hrD95

}

write.csv(mydat3,paste(data.dir,"RMS_lags_",f,"_Nov2020_quick_version.csv", sep="")) 
 }
