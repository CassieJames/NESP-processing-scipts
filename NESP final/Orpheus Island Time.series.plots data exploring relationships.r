...
data.dir="C:/Users/jc246980/Documents/Current projects/NESP/RMS calculations/Orpheus/"; setwd(data.dir)
RMScurrent<-fread("Orpheus_RMS_ALL.csv",sep=",")
...
p.SSC <- ggplot(MG2,aes(DateTime, SSC)) + geom_point(stat="identity", colour="#FF7F00", size=0.3) + theme_classic(base_size = 12)+scale_y_continuous(position = "left")+
		...
		scale_x_datetime(expand=c(0,0))+annotate(geom="text", x=as.POSIXct("2016-06-25 12:00", format = "%Y-%m-%d %H:%M"), y=150, label= "a.", size=6)+ylim(0,200)
...
p.Speed <- ggplot(MG2,aes(DateTime, as.numeric(Speed))) + geom_point(stat="identity", colour="darkslategray3", size=0.3) + theme_classic(base_size = 12)+scale_y_continuous(position = "left")+
		...
		scale_x_datetime(expand=c(0,0))+annotate(geom="text", x=as.POSIXct("2016-06-25 12:00", format = "%Y-%m-%d %H:%M"), y=0.45, label= "c.", size=6)+ylim(0,0.5)
...
p.flow <- ggplot(flowdata, aes(Date, Burdekin)) + geom_line(colour = "#377EB8") + theme_classic(base_size = 12)+scale_y_continuous(position = "left")+geom_area(position = "identity",fill="#377EB8")+
		...
		scale_x_date(date_breaks=("3 month"),date_labels = "%d/%m/%Y",expand=c(0,0),limits = as.Date(c('2016-06-01','2019-06-27')))+annotate(geom="text", x=as.Date("2016-06-25"), y=ypos, label= "g.", size=6)
...
png(paste(image.dir,"Orpheus Island July 2020.png",sep=''),width=40, height=(40/3)*2, units='cm', res=500, pointsize=10, bg='white')
...
p.RMS <- ggplot(MG2, aes(DateTime, RMS)) + geom_point(stat="identity",colour="#4DAF4A", size=0.3) + theme_minimal() + theme_classic(base_size = 12)+scale_y_continuous(position = "right",,limits=c(0,0.05))+
		theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),axis.title.y = element_text(colour="grey20",size=12))+ylab("RMS (pressure)")+
		scale_x_datetime(expand=c(0,0),limits =xpos)+annotate(geom="text", x=as.POSIXct("2016-06-05 12:00", format = "%Y-%m-%d %H:%M") , y=0.04, label= "b.", size=6) 
...
p.SSC <- ggplot(MG2,aes(DateTime, SSC)) + geom_point(stat="identity", colour="#FF7F00", size=0.3) + theme_classic(base_size = 12)+scale_y_continuous(position = "left")+
        ...
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),axis.title.y = element_text(colour="grey20",size=12))+ylab(bquote('SSC' ~(mg.L^-1)))+
		scale_x_datetime(expand=c(0,0),limits =xpos)+annotate(geom="text", x=as.POSIXct("2016-06-05 12:00", format = "%Y-%m-%d %H:%M"), y=12, label= "a.", size=6)+ylim(0,15)
...
p.Speed <- ggplot(MG2,aes(DateTime, as.numeric(Speed))) + geom_point(stat="identity", colour="darkslategray3", size=0.3) + theme_classic(base_size = 12)+scale_y_continuous(position = "left")+
        ...
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),axis.title.y = element_text(colour="grey20",size=12))+ylab(bquote('Current (m/s)'))+
		scale_x_datetime(expand=c(0,0),limits =xpos)+annotate(geom="text", x=as.POSIXct("2016-06-05 12:00", format = "%Y-%m-%d %H:%M"), y=0.45, label= "c.", size=6)+ylim(0,0.5)
...
p.RMScurrent <-ggplot(MG2,aes(DateTime, as.numeric(currentRMS))) + geom_point(stat="identity", colour="darkslateblue", size=0.3) + theme_classic(base_size = 12)+
        ...
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),axis.title.y = element_text(colour="grey20",size=12))+ylab(bquote('RMS (current)'))+
		scale_x_datetime(expand=c(0,0),limits =xpos)+annotate(geom="text", x=as.POSIXct("2016-06-05 12:00", format = "%Y-%m-%d %H:%M"), y=0.008, label= "d.", size=6)
	
ypos = min(flowdata$Burdekin,na.rm = TRUE) + 0.95*diff(range(flowdata$Burdekin,na.rm = TRUE))

xpos=as.Date(xpos, format="%m/%d/%Y")

p.flow <- ggplot(flowdata, aes(Date, Burdekin)) + geom_line(colour = "#377EB8") + theme_classic(base_size = 12)+scale_y_continuous(position = "left",limits=c(0,50000))+geom_area(position = "identity",fill="#377EB8")+
	...
	png(paste(image.dir,"Orpheus Island 2016 June-Dec.png",sep=''),width=40, height=(40/3)*2, units='cm', res=500, pointsize=10, bg='white')
        par(mar=c(4,4,1,1),cex=1,oma=c(2,0,1,0.5)) #		 
...
##### plots for shorter periods
library(scales)
xpos=c(as.POSIXct("2017-09-01 12:00", format = "%Y-%m-%d %H:%M") ,as.POSIXct("2018-06-30 23:50", format = "%Y-%m-%d %H:%M"))
...
p.RMS <- ggplot(MG2, aes(DateTime, RMS)) + geom_point(stat="identity",colour="#4DAF4A", size=0.3) + theme_minimal() + theme_classic(base_size = 12)+scale_y_continuous(position = "right",,limits=c(0,0.05))+
        ...
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),axis.title.y = element_text(colour="grey20",size=12))+ylab("RMS (pressure)")+
		scale_x_datetime(expand=c(0,0),limits =xpos)+annotate(geom="text", x=as.POSIXct("2017-09-05 12:00", format = "%Y-%m-%d %H:%M") , y=0.04, label= "b.", size=6) 
...
p.SSC <- ggplot(MG2,aes(DateTime, SSC)) + geom_point(stat="identity", colour="#FF7F00", size=0.3) + theme_classic(base_size = 12)+scale_y_continuous(position = "left")+
        ...
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),axis.title.y = element_text(colour="grey20",size=12))+ylab(bquote('SSC' ~(mg.L^-1)))+
		scale_x_datetime(expand=c(0,0),limits =xpos)+annotate(geom="text", x=as.POSIXct("2017-09-05 12:00", format = "%Y-%m-%d %H:%M"), y=40, label= "a.", size=6)+ylim(0,50)
...
p.NTUe <- ggplot(MG2,aes(DateTime, NTUe)) + geom_line(stat="identity", colour="#FF7F00", size=0.3) + theme_classic(base_size = 12)+scale_y_continuous(position = "right")+
        ...
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),axis.title.y = element_text(colour="grey20",size=12))+ylab(bquote('NTUe'))+
		scale_x_datetime(expand=c(0,0),limits =xpos)+annotate(geom="text", x=as.POSIXct("2017-09-05 12:00", format = "%Y-%m-%d %H:%M"), y=ypos, label= "d.", size=6) 
...
p.Hs <- ggplot(MG2,aes(DateTime, as.numeric(Hs))) + geom_point(stat="identity", colour="steelblue", size=0.3) + theme_classic(base_size = 12)+scale_y_continuous(position = "left")+
        ...
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),axis.title.y = element_text(colour="grey20",size=12))+ylab(bquote('Sig wave Ht (m)'))+
		scale_x_datetime(expand=c(0,0),limits =xpos)+annotate(geom="text", x=as.POSIXct("2017-09-05 12:00", format = "%Y-%m-%d %H:%M"), y=ypos, label= "e.", size=6) 
...
p.Speed <- ggplot(MG2,aes(DateTime, as.numeric(Speed))) + geom_point(stat="identity", colour="darkslategray3", size=0.3) + theme_classic(base_size = 12)+scale_y_continuous(position = "left")+
        ...
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),axis.title.y = element_text(colour="grey20",size=12))+ylab(bquote('Current (m/s)'))+
		scale_x_datetime(expand=c(0,0),limits =xpos)+annotate(geom="text", x=as.POSIXct("2017-09-05 12:00", format = "%Y-%m-%d %H:%M"), y=0.45, label= "c.", size=6)+ylim(0,0.5)
...
p.Height <- ggplot(MG2,aes(DateTime, as.numeric(Height))) + geom_point(stat="identity", colour="darkslateblue", size=0.3) + theme_classic(base_size = 12)+scale_y_continuous(position = "right")+
        ...
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),axis.title.y = element_text(colour="grey20",size=12))+ylab(bquote('Tide height (m)'))+
		scale_x_datetime(expand=c(0,0),limits =xpos)+annotate(geom="text", x=as.POSIXct("2017-09-05 12:00", format = "%Y-%m-%d %H:%M"), y=ypos, label= "f.", size=6)#+ylim(0,0.8)
...
p.RMScurrent <-ggplot(MG2,aes(DateTime, as.numeric(currentRMS))) + geom_point(stat="identity", colour="darkslateblue", size=0.3) + theme_classic(base_size = 12)+
        ...
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),axis.title.y = element_text(colour="grey20",size=12))+ylab(bquote('RMS (current)'))+
		scale_x_datetime(expand=c(0,0),limits =xpos)+annotate(geom="text", x=as.POSIXct("2017-09-05 12:00", format = "%Y-%m-%d %H:%M"), y=0.008, label= "d.", size=6)
	
ypos = min(flowdata$Burdekin,na.rm = TRUE) + 0.95*diff(range(flowdata$Burdekin,na.rm = TRUE))

xpos=as.Date(xpos, format="%m/%d/%Y")

p.flow <- ggplot(flowdata, aes(Date, Burdekin)) + geom_line(colour = "#377EB8") + theme_classic(base_size = 12)+scale_y_continuous(position = "left",limits=c(0,500000))+geom_area(position = "identity",fill="#377EB8")+
		theme(axis.title.x=element_blank(),axis.title.y = element_text(colour="grey20",size=12))+ylab(bquote('Discharge' ~(ML.d^-1)))+
		scale_x_date(date_breaks=("1 month"),date_labels = "%d/%m/%Y",expand=c(0,0),limits = xpos)+annotate(geom="text", x=as.Date("2017-09-05"), y=450000, label= "g.", size=6)

	
	#plot_grid(p.SSC,p.RMS, p.Speed, p.RMScurrent,p.Hs, p.Height,p.flow, align = "v", nrow = 7)	
	
	png(paste(image.dir,"Orpheus Island 2017-2018 Sep-June.png",sep=''),width=40, height=(40/3)*2, units='cm', res=500, pointsize=10, bg='white')
        par(mar=c(4,4,1,1),cex=1,oma=c(2,0,1,0.5)) #		 
